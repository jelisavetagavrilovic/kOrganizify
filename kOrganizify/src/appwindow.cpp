...
auto AppWindow::getColorFromPriority(CustomEventPriority priority) -> QColor {
    switch (priority) {
    case CustomEventPriority::NoPriority: return {247, 244, 248};
    case CustomEventPriority::Low: return {209, 244, 164};
    case CustomEventPriority::Medium: return {250, 226, 127};
    case CustomEventPriority::High: return {207, 91, 87};
    default: return {247, 244, 248};
    }
}
