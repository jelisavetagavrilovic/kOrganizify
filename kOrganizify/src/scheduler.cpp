...
Scheduler::Scheduler(Calendar *calendar, Calendar *basicCalendar,
                     QDate *startDate)
    : m_calendar(calendar), m_basicCalendar(basicCalendar),
      m_scheduledCalendar(new Calendar()), m_startDate(startDate) {}
...
auto Scheduler::findFreeTime(Calendar *cal1, int maxTimeInMinutes)
    -> QList<Event> {
