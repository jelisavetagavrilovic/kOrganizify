...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SaveLoad_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SaveLoad_t qt_meta_stringdata_SaveLoad = {
    {
QT_MOC_LITERAL(0, 8) // "SaveLoad"
...
const QMetaObject SaveLoad::staticMetaObject = { {
    ...
    qt_meta_stringdata_SaveLoad.offsetsAndSize,
    qt_meta_data_SaveLoad,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SaveLoad_t
...
void *SaveLoad::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SaveLoad.stringdata0))
